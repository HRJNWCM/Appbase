...
public class WheelMain
{
	...
	{
		hasSelectTime = true;
		this.initDateTimePicker(0, 0, 0, h, m);
	}
	...
	public void initDateTimePicker(int year, int month, int day, int h, int m)
	{
		...
		if (year != 0)
		{
			...
			{
				// 闰年
				if ((year % 4 == 0 && year % 100 != 0) || year % 400 == 0) wv_day
				        .setAdapter(new NumericWheelAdapter(1, 29));
				else
				        ...
				        int newValue)
				{
					...
					} else
					{
						if (((wv_year.getCurrentItem() + START_YEAR) % 4 == 0 && (wv_year
						        ...
						        || (wv_year.getCurrentItem() + START_YEAR) % 400 == 0) wv_day
						        .setAdapter(new NumericWheelAdapter(1, 29));
						else
							wv_day.setAdapter(new NumericWheelAdapter(1, 28));
					}
		...
		int textSize = 0;
		if (hasSelectTime) textSize = (screenheight / 100) * 3;
		else
	...
	public String getTime()
	{
		...
		if (!hasSelectTime) sb.append((wv_year.getCurrentItem() + START_YEAR))
		        .append("-").append((wv_month.getCurrentItem() + 1))
