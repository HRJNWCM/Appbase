...
import org.cj.R;
import org.cj.widget.time.calendar.MonthCellDescriptor.RangeState;
 ...
 * {@link #init(java.util.Date, java.util.Date)} and can be customized with any
 * of the
 * {@link com.marshalchen.common.uimodule.timessquare.CalendarPickerView.FluentInitializer}
 * methods returned. The currently selected date can be retrieved with
...
public class CalendarPickerView extends ListView
{
	...
	public CalendarPickerView(Context context, AttributeSet attrs)
	{
		...
		TypedArray a = context
		        .obtainStyledAttributes(attrs, R.styleable.CalendarPickerView);
		final int bg = a
		        .getColor(R.styleable.CalendarPickerView_android_background, res
		                .getColor(R.color.calendar_bg));
		dividerColor = a
		        .getColor(R.styleable.CalendarPickerView_dividerColor, res
		                .getColor(R.color.calendar_divider));
		dayBackgroundResId = a
		        .getResourceId(R.styleable.CalendarPickerView_dayBackground, R.drawable.calendar_bg_selector);
		dayTextColorResId = a
		        .getResourceId(R.styleable.CalendarPickerView_dayTextColor, R.color.calendar_text_selector);
		titleTextColor = a
		        .getColor(R.styleable.CalendarPickerView_titletextColor, R.color.calendar_text_active);
		headerTextColor = a
		        .getColor(R.styleable.CalendarPickerView_headerTextColor, R.color.calendar_text_active);
		a.recycle();
	 ...
	 * <p/>
	 * This will implicitly set the
	 * {@link com.marshalchen.common.uimodule.timessquare.CalendarPickerView.SelectionMode}
	 * to
	 * {@link com.marshalchen.common.uimodule.timessquare.CalendarPickerView.SelectionMode#SINGLE}
	 * . If you want a different selection mode, use
	 * {@link com.marshalchen.common.uimodule.timessquare.CalendarPickerView.FluentInitializer#inMode(com.marshalchen.common.uimodule.timessquare.CalendarPickerView.SelectionMode)}
	 * on the
	 * {@link com.marshalchen.common.uimodule.timessquare.CalendarPickerView.FluentInitializer}
	 * this method returns.
	 * <p/>
	...
	public FluentInitializer init(Date minDate, Date maxDate, Locale locale)
	{
		...
		maxCal = Calendar.getInstance(locale);
		monthCounter = Calendar.getInstance(locale);
		monthNameFormat = new SimpleDateFormat(getContext()
		...
		weekdayNameFormat = new SimpleDateFormat(getContext()
		...
		{ // But not > next yr.
			...
			MonthDescriptor month = new MonthDescriptor(monthCounter.get(MONTH), monthCounter
			        .get(YEAR), date, monthNameFormat.format(date));
	...
	public class FluentInitializer
	{
		 ...
		 * haven't already called
		 * {@link #inMode(com.marshalchen.common.uimodule.timessquare.CalendarPickerView.SelectionMode)}
		 * .
		 */
	...
	/**
	 * Select a new date. Respects the
	 * {@link com.marshalchen.common.uimodule.timessquare.CalendarPickerView.SelectionMode}
	 * this CalendarPickerView is configured with: if you are in
	 * {@link com.marshalchen.common.uimodule.timessquare.CalendarPickerView.SelectionMode#SINGLE}
	 * , the previously selected date will be un-selected. In
	 * {@link com.marshalchen.common.uimodule.timessquare.CalendarPickerView.SelectionMode#MULTIPLE}
	 * , the new date will be added to the list of selected dates.
	 * <p/>
	...
	private void validateDate(Date date)
	{
		...
		{
			throw new IllegalArgumentException(String.format("SelectedDate must be between minDate and maxDate."
			        + "%nminDate: %s%nmaxDate: %s%nselectedDate: %s", minCal
			        .getTime(), maxCal.getTime(), date));
		}
	}
	...
	private boolean doSelectDate(Date date, MonthCellDescriptor cell)
	{
		...
		if (date != null)
		{
			        ...
			        && selectedCells.size() > 1)
			{
				...
				selectedCells.get(0)
				        .setRangeState(MonthCellDescriptor.RangeState.FIRST);
				selectedCells.get(1)
	...
	private class MonthAdapter extends BaseAdapter
	{
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			...
			{
				monthView = MonthView
				        .create(parent, inflater, weekdayNameFormat, listener, today, dividerColor, dayBackgroundResId, dayTextColorResId, titleTextColor, headerTextColor);
			}
			monthView
			        .init(months.get(position), cells.get(position), displayOnly);
			return monthView;
		}
	}
	        ...
	        Calendar startCal)
	{
		        ...
		        && cal.get(YEAR) <= month.getYear())
		{
			...
			for ( int c = 0; c < 7; c++)
			{
				...
				weekCells
				        .add(new MonthCellDescriptor(date, isCurrentMonth, isSelectable, isSelected, isToday, isHighlighted, value, rangeState));
				cal.add(DATE, 1);
			}
		}
		return cells;
	 ...
	 * <p/>
	 * Important: set this before you call
	 * {@link #init(java.util.Date, java.util.Date)} methods. If called
	 * afterwards, it will not be consistently applied.
	 */
	 ...
	 * call {@link #selectDate(java.util.Date)} this listener will not be
	 * notified.
	 * 
	 * @see #setOnDateSelectedListener(com.marshalchen.common.uimodule.timessquare.CalendarPickerView.OnDateSelectedListener)
	 */
	 ...
	 * you call {@link #selectDate(java.util.Date)} this listener will not be
	 * notified.
	 * 
	 * @see #setOnInvalidDateSelectedListener(com.marshalchen.common.uimodule.timessquare.CalendarPickerView.OnInvalidDateSelectedListener)
	 */
	 ...
	 * 
	 * @see #setDateSelectableFilter(com.marshalchen.common.uimodule.timessquare.CalendarPickerView.DateSelectableFilter)
	 */
	        ...
	        OnInvalidDateSelectedListener
	{
		...
		{
			String errMessage = getResources()
			        .getString(R.string.invalid_date, fullDateFormat.format(minCal
			                .getTime()), fullDateFormat.format(maxCal.getTime()));
