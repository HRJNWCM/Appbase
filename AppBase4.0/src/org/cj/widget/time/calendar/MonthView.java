...
public class MonthView extends LinearLayout
{
	...
	{
		final MonthView view = (MonthView) inflater
		        .inflate(R.layout.calendar_month, parent, false);
		view.setDividerColor(dividerColor);
		if (dayTextColorResId != 0) view.setDayTextColor(dayTextColorResId);
		if (titleTextColor != 0) view.setTitleTextColor(titleTextColor);
		if (headerTextColor != 0) view.setHeaderTextColor(headerTextColor);
		if (dayBackgroundResId != 0) view.setDayBackground(dayBackgroundResId);
