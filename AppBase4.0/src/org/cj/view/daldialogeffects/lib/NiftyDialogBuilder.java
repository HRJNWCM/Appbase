...
public class NiftyDialogBuilder extends Dialog implements DialogInterface
{
	...
	public NiftyDialogBuilder withDialogColor(String colorString)
	{
		mLinearLayoutView.getBackground()
		        .setColorFilter(ColorUtils.getColorFilter(Color
		                .parseColor(colorString)));
		return this;
	}

	public NiftyDialogBuilder withDialogBackgroundColor(int id)
	{
		mLinearLayoutView.setBackgroundColor(id);
		return this;
	}
	...
	public NiftyDialogBuilder withButtonTextColor(int resid)
	{
