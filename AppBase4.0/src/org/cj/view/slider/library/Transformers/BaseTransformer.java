package org.cj.view.slider.library.Transformers;
 ...
 *
 * BaseTransformer implement {@link org.cj.view.slider.library.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link org.cj.view.slider.library.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link org.cj.view.slider.library.Animations.BaseAnimationInterface}
 * work.
 *
