...
import org.cj.R;
import org.cj.view.slider.library.Animations.BaseAnimationInterface;
import org.cj.view.slider.library.Indicators.PagerIndicator;
import org.cj.view.slider.library.SliderTypes.BaseSliderView;
import org.cj.view.slider.library.Transformers.AccordionTransformer;
import org.cj.view.slider.library.Transformers.BackgroundToForegroundTransformer;
import org.cj.view.slider.library.Transformers.BaseTransformer;
import org.cj.view.slider.library.Transformers.CubeInTransformer;
import org.cj.view.slider.library.Transformers.DefaultTransformer;
import org.cj.view.slider.library.Transformers.DepthPageTransformer;
import org.cj.view.slider.library.Transformers.FadeTransformer;
import org.cj.view.slider.library.Transformers.FlipHorizontalTransformer;
import org.cj.view.slider.library.Transformers.FlipPageViewTransformer;
import org.cj.view.slider.library.Transformers.ForegroundToBackgroundTransformer;
import org.cj.view.slider.library.Transformers.RotateDownTransformer;
import org.cj.view.slider.library.Transformers.RotateUpTransformer;
import org.cj.view.slider.library.Transformers.StackTransformer;
import org.cj.view.slider.library.Transformers.TabletTransformer;
import org.cj.view.slider.library.Transformers.ZoomInTransformer;
import org.cj.view.slider.library.Transformers.ZoomOutSlideTransformer;
import org.cj.view.slider.library.Transformers.ZoomOutTransformer;
import org.cj.view.slider.library.Tricks.FixedSpeedScroller;
import org.cj.view.slider.library.Tricks.InfinitePagerAdapter;
import org.cj.view.slider.library.Tricks.InfiniteViewPager;
import org.cj.view.slider.library.Tricks.ViewPagerEx;
 ...
 * {@link org.cj.view.slider.library.Indicators.PagerIndicator} and
 * {@link org.cj.view.slider.library.Tricks.ViewPagerEx} .
 * 
...
public class SliderLayout extends RelativeLayout
{
	...
	/**
	 * {@link org.cj.view.slider.library.Tricks.ViewPagerEx} indicator.
	 */
	...
	/**
	 * If {@link org.cj.view.slider.library.Tricks.ViewPagerEx} is Cycling
	 */
	...
	/**
	 * {@link org.cj.view.slider.library.Tricks.ViewPagerEx} transformer time
	 * span.
	 */
	...
	/**
	 * Visibility of
	 * {@link org.cj.view.slider.library.Indicators.PagerIndicator}
	 */
	private PagerIndicator.IndicatorVisibility	mIndicatorVisibility	= PagerIndicator.IndicatorVisibility.Visible;
	/**
	 * {@link org.cj.view.slider.library.Tricks.ViewPagerEx} 's transformer
	 */
	private BaseTransformer	                   mViewPagerTransformer;
	/**
	 * @see org.cj.view.slider.library.Animations.BaseAnimationInterface
	 */
	private BaseAnimationInterface	           mCustomAnimation;

	/**
	 * {@link org.cj.view.slider.library.Indicators.PagerIndicator} shape, rect
	 * or oval.
	 */
	...
	public SliderLayout(Context context, AttributeSet attrs, int defStyle)
	{
		...
		LayoutInflater.from(context)
		        .inflate(R.layout.slider_layout, this, true);
		...
		mTransformerSpan = attributes
		        .getInteger(R.styleable.SliderLayout_pager_animation_span, 1100);
		mTransformerId = attributes
		        .getInt(R.styleable.SliderLayout_pager_animation, Transformer.Default
		                .ordinal());
		mAutoCycle = attributes
		        .getBoolean(R.styleable.SliderLayout_auto_cycle, true);
		int visibility = attributes
		        .getInt(R.styleable.SliderLayout_indicator_visibility, 0);
		for ( PagerIndicator.IndicatorVisibility v : PagerIndicator.IndicatorVisibility
		        .values())
		{
	...
	{
		startAutoCycle(3000, mSliderDuration, mAutoRecover);
	}
	 ...
	 * details in
	 * {@link org.cj.view.slider.library.Animations.BaseAnimationInterface}, and
	 * you can see a example in
	 * {@link org.cj.view.slider.library.Animations.DescriptionAnimation}
	 * 
	 * @param animation
	 */
	...
	public void setIndicatorVisibility(
	        PagerIndicator.IndicatorVisibility visibility)
	{
		if (mIndicator == null)
		{
			return;
	...
	/**
	 * get the {@link org.cj.view.slider.library.Indicators.PagerIndicator}
	...
	public void removeAllSliders()
	{
		if (getRealAdapter() != null)
		{
			...
			mViewPager
			        .setCurrentItem(mViewPager.getCurrentItem() + count, false);
		}
	}
