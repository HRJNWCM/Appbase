...
public class SwipeItemMangerImpl implements SwipeItemMangerInterface
{
	...
	public SwipeItemMangerImpl(BaseAdapter adapter)
	{
		...
		if (!(adapter instanceof SwipeItemMangerInterface)) throw new IllegalArgumentException("adapter should implement the SwipeAdapterInterface");
	...
	public void initialize(View target, int position)
	{
		...
		swipeLayout
		        .setTag(resId, new ValueBox(position, swipeMemory, onLayoutListener));
	...
	public void openItem(int position)
	{
		...
		{
			if (!mOpenPositions.contains(position)) mOpenPositions
			        .add(position);
		} else
		{
	...
	class SwipeMemory extends SimpleSwipeListener
	{
		...
		{
			if (mode == Mode.Multiple) mOpenPositions.add(position);
			else
			{
				closeAllExcept(layout);
				mOpenPosition = position;
