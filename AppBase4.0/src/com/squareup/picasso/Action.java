...
abstract class Action<T>
{
	static class RequestWeakReference<M> extends WeakReference<M>
	{
		...
		public RequestWeakReference(
		        @SuppressWarnings("rawtypes") Action action, M referent,
	...
	Action(Picasso picasso, T target, Request request, int memoryPolicy,
	        int networkPolicy, int errorResId, Drawable errorDrawable,
